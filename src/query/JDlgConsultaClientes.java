...
public class JDlgConsultaClientes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Filtrar por gênero");

        jCboGenero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nenhum", "Masculino", "Feminino" }));
        jCboGenero.setPreferredSize(new java.awt.Dimension(100, 25));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String generoSelecionado = (String) jCboGenero.getSelectedItem();

        if (jTxtNome.getText().isEmpty() && "Nenhum".equals(generoSelecionado)) {
            List lista = clientes_DAO.listAll();
            clientesControle.setList(lista);
            System.out.println("Pesquisa geral");
        } else if (!jTxtNome.getText().isEmpty() && "Nenhum".equals(generoSelecionado)) {
            List lista = clientes_DAO.listNome(jTxtNome.getText());
            clientesControle.setList(lista);
            System.out.println("Consulta por nome");
        } else if (jTxtNome.getText().isEmpty() && !"Nenhum".equals(generoSelecionado)) {
            List lista = clientes_DAO.listGenero(generoSelecionado);
            clientesControle.setList(lista);
            System.out.println("Consulta por genero");
        } else if (!jTxtNome.getText().isEmpty() && ("Masculino".equals(generoSelecionado) || "Feminino".equals(generoSelecionado))) {
            List lista = clientes_DAO.listNomeGenero(jTxtNome.getText(), generoSelecionado);
            clientesControle.setList(lista);
            System.out.println("Consulta por genero e nome " + jTxtNome.getText() + generoSelecionado);
        }
