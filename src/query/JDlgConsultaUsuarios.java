...
public class JDlgConsultaUsuarios extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Filtrar por email");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTxtNome.getText().equals("") && jTxtEmail.getText().equals("")) {
            List lista = usuarios_DAO.listAll();
            usuariosControle.setList(lista);
            System.out.println("Geral");
        } else {
            if (!jTxtEmail.getText().equals("") && !jTxtNome.getText().equals("")) {
                List lista = usuarios_DAO.listNomeEmail(jTxtNome.getText(), jTxtEmail.getText());
                usuariosControle.setList(lista);
                System.out.println("Consulta por dois parametros");
            } else {
                if (!jTxtNome.getText().equals("")) {
                    ...
                    if (!jTxtEmail.getText().equals("")) {
                        List lista = usuarios_DAO.listEmail(jTxtEmail.getText());
                        usuariosControle.setList(lista);
                        System.out.println("Consulta por email");
                    }
                }
            }
        }
